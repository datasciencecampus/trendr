First off, thank you for considering contributing to `trendr`. It's people like you that make `trendr` such a great tool.
...
`trendr` is an open source project and we love to receive contributions from our community — you! There are many ways to contribute, from writing tutorials or blog posts, improving the documentation, submitting bug reports and feature requests or writing code which can be incorporated into Elasticsearch itself.
